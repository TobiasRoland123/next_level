import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from "../ui/nav-dropdown-menu";
  ...
  return (
    <>
      <DropdownMenu open={isHovered}>
        ...
        >
          {ItemList?.map((item) => (
            <DropdownMenuItem key={item.href} className="flex justify-center font-bold border-2 border-transparent hover:border-b-accentCol">
