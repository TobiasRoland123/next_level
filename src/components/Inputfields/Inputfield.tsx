...
const Input = React.forwardRef<HTMLInputElement, InputProps>(({ className, type, labelText, isSearch, valid, ...props }, ref) => {
  ...
  return (
    <div className="relative">
      ...
      {isSearch && inputValue === "" && (
        <div
          className={`absolute h-2 ${labelText ? "inset-y-10" : "inset-y-4"} right-0 pr-3 flex items-center pointer-events-none`}
        >
          <div>
            <IoIosSearch />
          </div>
