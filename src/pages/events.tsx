...
export default function Events() {
  return (
    <>
      <Layout>
        <main>
          <Hero header="Top tier gaming events" redWord={["gaming"]} isFrontPage={false} content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam non urna aliquet, mollis lacus sed, dignissim lectus. Curabitur eget diam volutpat, facilisis massa nec, varius nulla." buttonLabel="Kontakt os" />
          <section>
            <article className="flex justify-center">
              <div className="spacer w-full">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus auctor euismod posuere. Integer non ullamcorper mi. Vestibulum et congue lorem. Suspendisse iaculis semper mauris eget aliquet. </p>
