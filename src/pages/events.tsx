              ...
              <div className='spacer w-full'>
                <div>
                  <h2 className=' hyphens-auto'>
                    Forskellige typer{' '}
                    <span className='text-accentCol'>events</span>
                  </h2>
                  <p>
                    Som standard udbyder vi en række forskellige events. Har du
                    et ønske om et skræddersyet event, så{' '}
                    <a
                  ...
                  <div className=' flex flex-col items-center md:items-stretch md:flex-row md:flex-wrap gap-6 mt-10 md:mt-16 justify-around md:gap-10'>
                    ...
                    <EventCard
                      ...
                      image='turnering'
                      buttonProps={{
                        children: `Læs mere om turnering`,
                        link: './turnering',
                      }}
                    />
                  </div>
