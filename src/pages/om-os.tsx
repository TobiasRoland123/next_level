        ...
        <article className="flex justify-center  ">
          ...
          "
            ...
            <div className=" mt-6 md:mt-0">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam blandit quis ex faucibus commodo. Vestibulum
                consectetur elit erat. Cras et nulla eu purus luctus suscipit. Vivamus odio nisl, euismod quis sem pellentesque,
                rutrum aliquam metus. Duis lacus tortor, efficitur id consectetur in, eleifend eu nibh.
              </p>
            ...
            <div className="spacer w-full">
              ...
              <ul className="flex flex-col gap-16 md:grid grid-rows-2 grid-cols-3">
                <li className="text-center mt-8 col-start-2">
                  ...
                  <p className="mt-2">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam blandit quis ex faucibus commodo. Vestibulum
                    consectetur elit erat. Cras et nulla eu purus luctus suscipit.{" "}
                  </p>
                </li>
