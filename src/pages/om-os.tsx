...
export default function OmOs() {
  return (
    <>
      <Layout>
        <main>
          <Hero header="Hvem er next level?" redWord={["next", "level?"]} isFrontPage={false} content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam non urna aliquet, mollis lacus sed, dignissim lectus. Curabitur eget diam volutpat, facilisis massa nec, varius nulla." />
          ...
          "
                >
                  {/* <div className="bg-secondaryCol px-4 py-4 absolute -top-14 max-w-[250px] after:w-4 after:h-4 after:bg-secondaryCol after:absolute after:-bottom-2 after:right-28 after:rotate-45  ">
                <p className="font-bold  mt-0 text-primaryCol">Vibeholmsvej 22, 2605 Brøndby</p>
                <small className=" text-primaryCol mt-2">Søn - Tors 14:00 til 03:00</small>
                <small className=" text-primaryCol mt-2">Fre - Lør 14:00 til 04:00</small>
              </div> */}

                  <Image src={ParkMap} width={1000} height={1000} alt="Et kort, som viser hvilke muligheder der er for parkering" />
                </div>

                <div className=" mt-6 md:mt-0">
                  <h3 className="mt-0">find os her</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam blandit quis ex faucibus commodo. Vestibulum consectetur elit erat. Cras et nulla eu purus luctus suscipit. Vivamus odio nisl, euismod quis sem pellentesque, rutrum aliquam metus. Duis lacus tortor, efficitur id consectetur in, eleifend eu nibh.</p>
                        ...
                        <ul>
                          <li>
                            <div className="flex items-start gap-4 mt-4 ">
                              ...
                              <p className="mt-0 hyphens-auto" lang="da">
                          ...
                          <li>
                            <div className="flex items-center gap-4 mt-4">
                              ...
                              <a className="mt-0 hyphens-auto" lang="da" href="tel:50988887">
                                50 98 88 87
                              </a>
                            </div>
                          </li>
                          <li>
                            <div className="flex items-center gap-4 mt-4">
                              ...
                              <a className="mt-0 hyphens-auto" lang="da" href="mailto:info@nextlvl.dk">
                                info@nextlvl.dk
                              </a>
                            </div>
                          </li>
            ...
            <section>
              ...
              <article className="flex justify-center ">
                <div className="spacer w-full">
                  <h2 className=" hyphens-auto" lang="da">
                  ...
                  <ul className="flex flex-col gap-16 md:grid grid-rows-2 grid-cols-3">
                    <li className="text-center mt-8 col-start-2">
                      ...
                      <h3 className="mt-3 hyphens-auto" lang="da">
                        Sammenhold
                      </h3>
                      <p className="mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam blandit quis ex faucibus commodo. Vestibulum consectetur elit erat. Cras et nulla eu purus luctus suscipit. </p>
                    </li>
